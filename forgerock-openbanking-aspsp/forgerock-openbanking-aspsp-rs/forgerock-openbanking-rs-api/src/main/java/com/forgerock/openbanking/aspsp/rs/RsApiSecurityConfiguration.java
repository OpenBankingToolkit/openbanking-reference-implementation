...
public class RsApiSecurityConfiguration {
    ...
    @Autowired
    public RsApiSecurityConfiguration(KeyStoreService keyStoreService, TppStoreService tppStoreService) {
    ...
    @Bean
    @Primary
    public OBRIExternalCertificates rsApiObriExternalCertificates() throws Exception {
