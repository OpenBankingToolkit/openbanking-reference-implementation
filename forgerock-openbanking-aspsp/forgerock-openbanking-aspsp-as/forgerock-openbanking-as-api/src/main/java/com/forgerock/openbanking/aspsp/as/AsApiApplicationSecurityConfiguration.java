...
class AsApiApplicationSecurityConfiguration {
    ...
    @Autowired
    public AsApiApplicationSecurityConfiguration(KeyStoreService keyStoreService, TppStoreService tppStoreService) {
